DROP DATABASE IF EXISTS "schema786";
CREATE DATABASE "schema786";
USE "schema786";
...
CREATE TABLE "manager" (
	...
	"to_date" DATE,
	 ...
	 CONSTRAINT "fkeycon_manager_to_employees" FOREIGN KEY ("emp_no") REFERENCES "employees" ("emp_no"),
	 CONSTRAINT "fkeycon_manager_to_departments" FOREIGN KEY ("dept_no") REFERENCES "departments" ("dept_no")
);
