DROP DATABASE IF EXISTS "schema505";
CREATE DATABASE "schema505";
USE "schema505";
...
CREATE TABLE "scenarios" (
	...
	"parameter_set" TEXT,
	"price_type" TEXT,
	"price_sensitivity_coefficient" REAL,
	"electric_grid_operation_limit_type" TEXT,
	"thermal_grid_operation_limit_type" TEXT,
	"timestep_start" TEXT,
	"timestep_end" TEXT,
	"timestep_interval" TEXT,
	"base_apparent_power" REAL,
	"base_voltage" REAL,
	"base_thermal_power" REAL,
...
CREATE TABLE "electric_grids" (
	...
	"source_node_name" TEXT,
	"base_frequency" TEXT,
	"is_single_phase_equivalent" TEXT,
