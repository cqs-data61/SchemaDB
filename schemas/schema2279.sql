DROP DATABASE IF EXISTS "schema2279";
CREATE DATABASE "schema2279";
USE "schema2279";
...
CREATE TABLE "managers" (
	...
	"to_date" DATE,
	 ...
	 CONSTRAINT "fkeycon_managers_to_departments" FOREIGN KEY ("dept_no") REFERENCES "departments" ("dept_no")
);
