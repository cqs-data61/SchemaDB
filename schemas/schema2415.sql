DROP DATABASE IF EXISTS "schema2415";
CREATE DATABASE "schema2415";
USE "schema2415";
...
CREATE TABLE "node_field_revision" (
	...
	"default_langcode" TINYINT,
	"revision_translation_affected" TINYINT,
	"content_translation_source" VARCHAR,
	"content_translation_outdated" TINYINT,
...
CREATE TABLE "ip2country_temp" (
	"ip2country_id" INT,
	"country" CHAR,
	"registry" CHAR,
	"ip_range_first" BIGINT,
	"ip_range_last" BIGINT,
	"ip_range_length" INT,
