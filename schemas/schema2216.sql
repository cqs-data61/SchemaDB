DROP DATABASE IF EXISTS "schema2216";
CREATE DATABASE "schema2216";
USE "schema2216";
...
CREATE TABLE "employees" (
	...
	"hire_date" DATE,
	 ...
	 CONSTRAINT "fkeycon_employees_to_salaries" FOREIGN KEY ("emp_no") REFERENCES "salaries" ("emp_no")
);
...
CREATE TABLE "dept_emp" (
	...
	"dept_no" VARCHAR,
	 ...
	 CONSTRAINT "fkeycon_dept_emp_to_salaries" FOREIGN KEY ("emp_no") REFERENCES "salaries" ("emp_no"),
...
CREATE TABLE "dept_manager" (
	...
	"emp_no" INTEGER,
	 ...
	 CONSTRAINT "fkeycon_dept_manager_to_salaries" FOREIGN KEY ("emp_no") REFERENCES "salaries" ("emp_no")
);
